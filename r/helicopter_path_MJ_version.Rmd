...
dem <- "C:/Projects/20230829_HeliWaterPoints/MJ_Methodology/data/DEM_SE_Tas_mosaic.tif"
water_poly_full_path <- "C:/Projects/20230829_HeliWaterPoints/MJ_Methodology/data/reservoir_all_new.shp"
new_dams_full_path <- "C:/Projects/20230829_HeliWaterPoints/MJ_Methodology/data/potential_dam_locations_14052020.shp"
...
-   For every line from point grid to water, densify line (make vertice every 100 metres) and turn vertices into points (transferring line id to new point feature class)
...
### chunk 10 Test whether this process has actually added any value
...
#fit linear regression model using 'dist' as predictor and 'total_time_slope' as response variable
model <- lm(total_time_slope ~ dist, data=test_df)

summary(model)
plot(model)

#create scatterplot of raw data
plot(test_df$dist, test_df$total_time_slope, col='red', main='Summary of Regression Model', xlab='Distance', ylab='Total Time') + abline(lm(total_time_slope ~ dist, data=test_df))
